<x-app-shell title="Dashboard Teller" header="Teller">
            ...
            <table class="min-w-full text-sm">
                <thead>
                    <tr class="border-b text-gray-500">
                        ...
                        <th class="text-left py-3 pr-4">Lokasi</th>
                ...
                <tbody id="document-table-body">
                    @forelse($documents as $doc)
                        <tr class="border-b hover:bg-gray-50 document-row" data-status="{{ $doc->status }}"
                            ...
                            <td class="py-3 pr-4">Lmr {{ $doc->cabinet }} / Rak {{ $doc->shelf }} / Box
                                {{ $doc->box }}</td>
                            <td class="py-3 pr-4">
                            ...
                            <div
                                ...
                                <div id="viewSection{{ $doc->id }}" class="p-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div><label class="text-xs text-gray-500">Kategori</label>
                                            <div class="font-medium">{{ $doc->category }}</div>
                                        </div>
                                        <div><label class="text-xs text-gray-500">Tanggal</label>
                                            <div class="font-medium">{{ $doc->document_date }}</div>
                                        </div>
                                        <div><label class="text-xs text-gray-500">Lemari</label>
                                            <div class="font-medium">Lemari {{ $doc->cabinet }}</div>
                                        </div>
                                        <div><label class="text-xs text-gray-500">Rak & Box</label>
                                            <div class="font-medium">Rak {{ $doc->shelf }} - Box {{ $doc->box }}
                                            </div>
                                        </div>
                                        <div class="md:col-span-2"><label
                                                class="text-xs text-gray-500">Keterangan</label>
                                            ...
                                            <div>
                                                ...
                                                <select name="category" class="w-full rounded-lg border-gray-300">
                                                    ...
                                                    <option value="Slip Setoran"
                                                        {{ $doc->category == 'Slip Setoran' ? 'selected' : '' }}>Slip
                                                        Setoran</option>
                    ...
                    @empty
                        <tr id="empty-row">
                            <td colspan="6" class="text-center py-6 text-gray-500">Belum ada dokumen.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    {{-- MODAL UPLOAD --}}
    <div id="uploadModal" class="fixed inset-0 bg-black/40 hidden items-center justify-center p-4 z-50">
        <div class="bg-white w-full max-w-2xl rounded-xl border shadow-lg max-h-[90vh] overflow-y-auto">
            <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-5 border-b flex items-center justify-between">
                    <h3 class="text-lg font-semibold">Upload Dokumen Teller</h3>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-2 flex flex-col items-center">
                        <div
                            ...
                            <img id="preview-upload-img" class="hidden h-full object-contain">
                            <span id="preview-placeholder" class="text-gray-400 text-sm">Preview Gambar</span>
                        </div>
                        <input type="file" name="file_path" onchange="previewImage(event, 'preview-upload-img')"
                    ...
                    <div><label class="block text-sm font-medium mb-1">Tanggal</label><input type="date"
                            name="document_date" class="w-full rounded-lg border-gray-300" required></div>
                    <div><label class="block text-sm font-medium mb-1">No Dokumen</label><input type="text"
                            name="document_number" class="w-full rounded-lg border-gray-300" required></div>
                    ...
                    <div class="md:col-span-2"><label class="block text-sm font-medium mb-1">Keterangan</label><input
                            type="text" name="description" class="w-full rounded-lg border-gray-300"></div>
                </div>
