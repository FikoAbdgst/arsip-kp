<x-app-shell title="Reports" header="Reports">
    ...
    <div class="bg-white rounded-xl border p-6 mt-6">
        ...
        <form action="{{ route('reports.index') }}" method="GET"
            ...
            <div>
                ...
                <select name="status" class="w-full rounded-lg border-gray-300 focus:border-blue-500">
            ...
            <div class="lg:col-span-4 flex flex-col sm:flex-row gap-2 sm:justify-end mt-2">
                <a href="{{ route('reports.index') }}"
                    class="px-4 py-2 rounded-lg border bg-white hover:bg-gray-50 text-sm text-center">Reset</a>
                <button type="submit"
                    class="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 text-sm">Terapkan
                    Filter</button>
            </div>
        </form>

        {{-- Di Bagian Button Export --}}
        <div class="flex gap-2 justify-end">
            <a href="{{ route('reports.export.pdf', request()->query()) }}"
                class="px-3 py-2 rounded-lg border bg-white hover:bg-gray-50 text-sm">Export PDF</a>
            <a href="{{ route('reports.export.excel', request()->query()) }}"
                class="px-3 py-2 rounded-lg border bg-white hover:bg-gray-50 text-sm">Export Excel</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border p-6 mt-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
            ...
            <div class="flex gap-2 justify-end">
                <button type="button" class="px-3 py-2 rounded-lg border bg-white hover:bg-gray-50 text-sm">
                    Export PDF
                </button>
                <button type="button" class="px-3 py-2 rounded-lg border bg-white hover:bg-gray-50 text-sm">
                    Export Excel
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                ...
                <tbody>
                    @foreach ([['no' => 'SLP-021', 'kategori' => 'Slip Setoran', 'sumber' => 'Teller', 'tanggal' => '2026-02-04', 'lokasi' => 'Lemari A • Rak 2 • Kotak 7', 'status' => 'Approved'], ['no' => 'TRF-019', 'kategori' => 'Bukti Transfer', 'sumber' => 'Teller', 'tanggal' => '2026-02-04', 'lokasi' => 'Lemari A • Rak 2 • Kotak 7', 'status' => 'Pending'], ['no' => 'KEL-007', 'kategori' => 'Keluhan Nasabah', 'sumber' => 'CS', 'tanggal' => '2026-02-04', 'lokasi' => 'Lemari B • Rak 1 • Kotak 3', 'status' => 'Rejected'], ['no' => 'FRM-002', 'kategori' => 'Form Rekening', 'sumber' => 'CS', 'tanggal' => '2026-02-03', 'lokasi' => 'Lemari B • Rak 1 • Kotak 3', 'status' => 'Approved']] as $doc)
                        <tr class="border-b">
