<x-app-shell title="Dashboard CS" header="Customer Service">
    ...
    <div class="bg-white rounded-xl border p-6">
        ...
        <div class="text-sm text-gray-600 mt-1">
            Monitoring dan upload dokumen Customer Service.
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
        <div class="bg-white rounded-xl border p-4">
            <div class="text-sm text-gray-500">Total Dokumen CS</div>
            <div class="text-2xl font-semibold mt-1">50</div>
            <div class="text-xs text-gray-500 mt-1">Semua dokumen CS</div>
        </div>
        ...
        <div class="bg-white rounded-xl border p-4">
            ...
            <div class="text-2xl font-semibold mt-1">4</div>
...
@endif
    ...
    <div class="bg-white rounded-xl border p-6 mt-4">
        <h3 class="text-lg font-semibold mb-4">Dokumen CS Terbaru</h3>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                ...
                <tbody>
                    @foreach ([
                        ['no' => 'FRM-002', 'kategori' => 'Form Rekening', 'tanggal' => '2026-02-04', 'status' => 'Approved'],
                        ['no' => 'KEL-007', 'kategori' => 'Keluhan Nasabah', 'tanggal' => '2026-02-04', 'status' => 'Pending'],
                        ['no' => 'TTP-001', 'kategori' => 'Penutupan Rekening', 'tanggal' => '2026-02-03', 'status' => 'Approved'],
                    ] as $doc)
                    <tr class="border-b">
