<x-app-shell title="Dashboard CS" header="Customer Service">
                ...
                <table class="min-w-full text-sm">
                    <thead>
                        <tr class="border-b text-gray-500 bg-gray-50 text-left">
                            ...
                            <th class="py-3 px-4 font-medium">CIF</th>
                            ...
                            <th class="py-3 px-4 font-medium">Status Approval</th>
                    ...
                    <tbody id="document-table-body">
                        ...
                        @forelse($documents as $doc)
                            ...
                            <tr class="border-b hover:bg-gray-50 transition {{ $rowClass }}">
                                ...
                                <td class="py-3 px-4">{{ $doc->cif }}</td>
                                {{-- UPDATE DISINI: Menampilkan nama lengkap dari Map --}}
                                ...
                                <td class="py-3 px-4">
                                    @if ($doc->status === 'approved')
                                        <span
                                            class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-700 border border-green-200">Approved</span>
                                    @elseif($doc->status === 'rejected')
                                        <span
                                            class="px-2 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-700 border border-red-200">Rejected</span>
                                    @else
                                        <span
                                            class="px-2 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-700 border border-yellow-200">Pending</span>
                                    @endif
                                </td>
                                            ...
                                            <div id="viewSection{{ $doc->id }}" class="p-6">
                                                @if ($doc->status == 'rejected')
                                                    <div
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mt-2 text-xs text-red-600 font-semibold">Silakan
                                                                Edit
                                                                untuk
                                                                upload ulang revisi, atau Hapus jika tidak diperlukan.
                                                            </p>
                                                        </div>
                                                    </div>
                                                @elseif ($doc->status == 'approved')
                                                    <div
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-sm mt-1">Dokumen ini telah diverifikasi dan
                                                                disetujui.
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    <div
                                                        ...
                                                        @else
                                                            <div
                                                                class="text-gray-400 py-10 flex flex-col items-center">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="h-12 w-12 mb-2" fill="none"
                                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                    ...
                                                    <div class="space-y-4">
                                                        ...
                                                        <div>
                                                            <label
                                                                class="text-xs font-bold text-gray-500 uppercase">Tanggal</label>
                                                            <div class="font-medium text-gray-900">
                                                ...
                                                <form action="{{ route('documents.update', $doc->id) }}"
                                                    ...
                                                    <div class="p-6">
                                                            ...
                                                            <div class="flex">
                                                                ...
                                                                <div class="ml-3">
                                                                    <p class="text-sm text-yellow-700">
                                                                        Anda sedang dalam mode edit. Menyimpan
                                                                        perubahan akan
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            ...
                                                            <div class="md:col-span-2">
                                                                <label
                                                                    class="block text-sm font-medium mb-1">Tanggal</label>
                                                            ...
                                                            <div>
                                                                <label
                                                                    class="block text-sm font-medium mb-1">CIF</label>
                                                                <input type="text" name="cif"
                                                                    value="{{ old('form_selector') == 'edit-' . $doc->id ? old('cif') : $doc->cif }}"
                                                                    class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                                                    required>
                                                                @if (old('form_selector') == 'edit-' . $doc->id)
                                                                    @error('cif')
                                                            ...
                                                            <div class="md:col-span-2 text-center border-b pb-4 mb-2">
                                                                ...
                                                                <p class="text-xs text-gray-500 mt-1">Kosongkan jika
                                                                    tidak
                                                                    ingin
                                                                    mengubah file.</p>
                                                                @if (old('form_selector') == 'edit-' . $doc->id)
                                                            ...
                                                            <div>
                                                                <label
                                                                    class="block text-sm font-medium mb-1">Lemari</label>
                                                                <select name="cabinet"
                                                                    class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                                                            ...
                                                            <div>
                                                                <label
                                                                    class="block text-sm font-medium mb-1">Rak</label>
                                                                <select name="shelf"
                                                                    class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                                                            ...
                                                            <div>
                                                                <label
                                                                    class="block text-sm font-medium mb-1">Kotak</label>
                                                                <select name="box"
                                                                    class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">
    ...
    <div id="uploadModalCs"
        ...
        <div class="bg-white w-full max-w-2xl rounded-2xl border shadow-2xl max-h-[90vh] overflow-y-auto">
            <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="source" value="cs">
                <input type="hidden" name="form_selector" value="uploadModalCs">

                <div class="p-5 border-b flex items-center justify-between bg-gray-50 rounded-t-2xl">
                    <h3 class="text-lg font-bold text-gray-800">Upload Dokumen CS</h3>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="kategori_cs" name="category"
                            class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                            required>
                            <option value="" selected disabled>Pilih Kategori...</option>
                            <option value="FPR"
                                {{ old('form_selector') == 'uploadModalCs' && old('category') == 'FPR' ? 'selected' : '' }}>
                                Form pembukaan rekening (FPR)</option>
                            <option value="PDN"
                                {{ old('form_selector') == 'uploadModalCs' && old('category') == 'PDN' ? 'selected' : '' }}>
                                Form perubahan data nasabah (PDN)</option>
                            <option value="FPTR"
                                {{ old('form_selector') == 'uploadModalCs' && old('category') == 'FPTR' ? 'selected' : '' }}>
                                Form penutupan rekening (FPTR)</option>
                            <option value="FPL"
                                {{ old('form_selector') == 'uploadModalCs' && old('category') == 'FPL' ? 'selected' : '' }}>
                                Form Layanan kartu & digital banking (FPL)</option>
                        </select>
                        @if (old('form_selector') == 'uploadModalCs')
                            @error('category')
                    ...
                    <div>
                        ...
                        <input id="nomor_dokumen_cs" type="text" name="document_number"
                            value="{{ old('form_selector') == 'uploadModalCs' ? old('document_number') : '' }}"
                            class="w-full rounded-lg border-gray-300 bg-gray-100 cursor-not-allowed" placeholder="-"
                            readonly required>
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Tanggal</label>
                        <input type="date" name="document_date"
                            value="{{ old('form_selector') == 'uploadModalCs' ? old('document_date') : '' }}"
                            class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                            required>
                        @if (old('form_selector') == 'uploadModalCs')
                            @error('document_date')
                    ...
                    <div>
                        ...
                        <input type="text" name="cif"
                            value="{{ old('form_selector') == 'uploadModalCs' ? old('cif') : '' }}"
                            class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                            required>
                        @if (old('form_selector') == 'uploadModalCs')
                            @error('cif')
                    ...
                    <div class="md:col-span-2 flex flex-col items-center">
                        <div
                            ...
                            <img id="preview-upload-cs" class="hidden h-full object-contain z-10">
                            <div id="preview-placeholder-cs" class="text-center">
                    ...
                    <div>
                        ...
                        <select name="cabinet"
                            ...
                            @foreach (['A', 'B', 'C', 'D'] as $c)
                                <option value="{{ $c }}"
                                    {{ old('form_selector') == 'uploadModalCs' && old('cabinet') == $c ? 'selected' : '' }}>
                                    Lemari {{ $c }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="shelf"
                            ...
                            @foreach (range(1, 5) as $i)
                                <option value="{{ $i }}"
                                    {{ old('form_selector') == 'uploadModalCs' && old('shelf') == $i ? 'selected' : '' }}>
                                    Rak {{ $i }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="box"
                            ...
                            @foreach (range(1, 10) as $i)
                                <option value="{{ $i }}"
                                    {{ old('form_selector') == 'uploadModalCs' && old('box') == $i ? 'selected' : '' }}>
                                    Kotak {{ $i }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="md:col-span-2"><label class="block text-sm font-medium mb-1">Keterangan</label>
                        <textarea name="description" rows="2"
                            class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                            placeholder="Masukkan Keterangan (opsional)">{{ old('form_selector') == 'uploadModalCs' ? old('description') : '' }}</textarea>
                    </div>
                    ...
                    <div class="p-5 border-t md:col-span-2 bg-gray-50 flex justify-end gap-2 rounded-b-2xl">
                        <button type="button" onclick="closeModal('uploadModalCs')"
                            class="px-4 py-2 border rounded-lg bg-white text-gray-700 hover:bg-gray-50 font-medium">Batal</button>
                        <button type="submit"
                            class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium shadow-sm">Upload</button>
                    </div>
            </form>
        </div>
    </div>
    ...
    <script>
        // --- 1. LOGIC FORM & INPUT ---
        const kategoriCs = document.getElementById('kategori_cs');
        const noDocCs = document.getElementById('nomor_dokumen_cs');

        if (kategoriCs) {
            kategoriCs.addEventListener('change', function() {
                const prefix = this.value;
                if (!prefix) return;

                noDocCs.value = 'Loading...';

                fetch(`{{ route('documents.generate-number') }}?prefix=${prefix}`)
                    .then(res => res.json())
                    .then(data => {
                        noDocCs.value = data.number;
                    })
                    .catch(err => {
                        console.error(err);
                        noDocCs.value = 'Error';
        ...
        function openModal(id) {
            ...
            if (el) {
                ...
                // Tambahkan class penanda agar script refresh tahu ada modal buka
        ...
        // --- 3. SMART REALTIME REFRESH ---
        function startSmartRealtime() {
            setInterval(() => {
                // Cek apakah ada elemen dengan class 'modal-is-open' ATAU modal yang tidak hidden
                const openModals = document.querySelectorAll('.fixed.inset-0:not(.hidden)');

                // JIKA ADA MODAL TERBUKA, STOP REFRESH
                if (openModals.length > 0) {
                    console.log('Refresh ditahan: User sedang membuka modal.');
                    return;
                }

                // Jika tidak ada modal, lakukan refresh partial
                fetch(window.location.href, {
                    ...
                    .then(html => {
                        ...
                        // Update Statistik
                        const newStats = doc.getElementById('cs-stats');
                        const currentStats = document.getElementById('cs-stats');
                        if (newStats && currentStats) {
                            currentStats.innerHTML = newStats.innerHTML;
                        }

                        // Update Tabel
                        const newTable = doc.getElementById('cs-table');
                        const currentTable = document.getElementById('cs-table');
    ...
    `;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Re-open modal jika ada error validasi dari server
            let formSelector = "{{ old('form_selector') }}";
            if (formSelector === 'uploadModalCs') {
                openModal('uploadModalCs');
